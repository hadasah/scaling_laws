...
def check_args(args):
    ...
    if args.lr_cooldown_end_ratio > 0:
        assert (
            args.lr_cooldown_end == 0
        ), "Can only set one of args.lr_cooldown_end and args.lr_cooldown_end_ratio"
        args.lr_cooldown_end = args.lr_cooldown_end_ratio * args.lr
...
def parse_args(args):
    ...
    parser.add_argument(
        "-l", "--logs", ## TODO @margsli renamed bc of torch bug https://github.com/pytorch/pytorch/issues/120601
        type=str,
        default="./logs/",
    ...
    parser.add_argument(
        "--lr-cooldown-end-ratio",
        type=float,
        default=0,
        help="End learning rate multiplier for cooldown schedule. Default: 0",
    )
    parser.add_argument(
        "--lr-cooldown-power",
        type=float,
