...
def world_info_from_env():
    ...
    for v in ("RANK", "PMI_RANK", "SLURM_PROCID", "OMPI_COMM_WORLD_RANK"):
        if v in os.environ:
            ...
            break
    print("RANK", os.environ.get("RANK"), os.environ.get("PMI_RANK"), os.environ.get("SLURM_PROCID"), os.environ.get("OMPI_COMM_WORLD_RANK"))
    world_size = 1
    for v in ("WORLD_SIZE", "PMI_SIZE", "SLURM_NTASKS", "OMPI_COMM_WORLD_SIZE"):
        if v in os.environ:
            world_size = int(os.environ[v])
            break
    print("WORLD_SIZE", os.environ.get("WORLD_SIZE"), os.environ.get("PMI_SIZE"), os.environ.get("SLURM_NTASKS"), os.environ.get("OMPI_COMM_WORLD_SIZE"))
...
def init_distributed_device(args):
    ...
    print("os.environ['WORLD_SIZE']", os.environ.get("WORLD_SIZE", "None"))
    print("os.environ['SLURM_NTASKS']", os.environ.get('SLURM_NTASKS', "None"))
